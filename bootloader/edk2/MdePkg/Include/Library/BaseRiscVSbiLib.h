...
SBI_RET
EFIAPI
SbiCall(IN UINTN ExtId, IN UINTN FuncId, IN UINTN NumArgs, ...);

EFI_STATUS
EFIAPI
TranslateError(IN UINTN SbiError);

VOID EFIAPI SbiSetTimer(IN UINT64 Time);

EFI_STATUS
EFIAPI
SbiSystemReset(IN UINTN ResetType, IN UINTN ResetReason);
...
EFI_STATUS
EFIAPI
SbiProbeExtension(IN UINTN Extension);
