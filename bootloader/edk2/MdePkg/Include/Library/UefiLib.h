...
EFI_STATUS
EFIAPI
EfiNamedEventListen(IN CONST EFI_GUID *Name, IN EFI_TPL NotifyTpl, IN EFI_EVENT_NOTIFY NotifyFunction, IN CONST VOID *NotifyContext OPTIONAL, OUT VOID *Registration OPTIONAL);
...
EFI_STATUS
EFIAPI
EfiNamedEventSignal(IN CONST EFI_GUID *Name);
...
EFI_STATUS
EFIAPI
EfiEventGroupSignal(IN CONST EFI_GUID *EventGroup);
...
EFI_STATUS
EFIAPI
EfiTestManagedDevice(IN CONST EFI_HANDLE ControllerHandle, IN CONST EFI_HANDLE DriverBindingHandle, IN CONST EFI_GUID *ProtocolGuid);
...
EFI_STATUS
EFIAPI
EfiTestChildHandle(IN CONST EFI_HANDLE ControllerHandle, IN CONST EFI_HANDLE ChildHandle, IN CONST EFI_GUID *ProtocolGuid);
...
EFI_STATUS
EFIAPI
IsLanguageSupported(IN CONST CHAR8 *SupportedLanguages, IN CONST CHAR8 *TargetLanguage);
...
EFI_STATUS
EFIAPI
LookupUnicodeString(IN CONST CHAR8 *Language, IN CONST CHAR8 *SupportedLanguages, IN CONST EFI_UNICODE_STRING_TABLE *UnicodeStringTable, OUT CHAR16 **UnicodeString);
...
EFI_STATUS
EFIAPI
LookupUnicodeString2(IN CONST CHAR8 *Language, IN CONST CHAR8 *SupportedLanguages, IN CONST EFI_UNICODE_STRING_TABLE *UnicodeStringTable, OUT CHAR16 **UnicodeString, IN BOOLEAN Iso639Language);
...
EFI_STATUS
EFIAPI
AddUnicodeString(IN CONST CHAR8 *Language, IN CONST CHAR8 *SupportedLanguages, IN OUT EFI_UNICODE_STRING_TABLE **UnicodeStringTable, IN CONST CHAR16 *UnicodeString);
...
EFI_STATUS
EFIAPI
AddUnicodeString2(IN CONST CHAR8 *Language, IN CONST CHAR8 *SupportedLanguages, IN OUT EFI_UNICODE_STRING_TABLE **UnicodeStringTable, IN CONST CHAR16 *UnicodeString, IN BOOLEAN Iso639Language);
...
EFI_STATUS
EFIAPI
FreeUnicodeStringTable(IN EFI_UNICODE_STRING_TABLE *UnicodeStringTable);
...
EFI_STATUS
EFIAPI
GetVariable2(IN CONST CHAR16 *Name, IN CONST EFI_GUID *Guid, OUT VOID **Value, OUT UINTN *Size OPTIONAL);
...
UINTN
EFIAPI
GetGlyphWidth(IN CHAR16 UnicodeChar);
...
UINTN
EFIAPI
UnicodeStringDisplayLength(IN CONST CHAR16 *String);
...
EFI_STATUS
EFIAPI
EfiCreateEventLegacyBoot(OUT EFI_EVENT *LegacyBootEvent);
...
EFI_STATUS
EFIAPI
EfiCreateEventLegacyBootEx(IN EFI_TPL NotifyTpl, IN EFI_EVENT_NOTIFY NotifyFunction OPTIONAL, IN VOID *NotifyContext OPTIONAL, OUT EFI_EVENT *LegacyBootEvent);
...
EFI_STATUS
EFIAPI
EfiCreateEventReadyToBoot(OUT EFI_EVENT *ReadyToBootEvent);
...
EFI_STATUS
EFIAPI
EfiCreateEventReadyToBootEx(IN EFI_TPL NotifyTpl, IN EFI_EVENT_NOTIFY NotifyFunction OPTIONAL, IN VOID *NotifyContext OPTIONAL, OUT EFI_EVENT *ReadyToBootEvent);
...
UINTN
EFIAPI
ErrorPrint(IN CONST CHAR16 *Format, ...);
...
UINTN
EFIAPI
AsciiPrint(IN CONST CHAR8 *Format, ...);
...
UINTN
EFIAPI
AsciiErrorPrint(IN CONST CHAR8 *Format, ...);
...
UINTN
EFIAPI
PrintXY(IN UINTN PointX, IN UINTN PointY, IN EFI_GRAPHICS_OUTPUT_BLT_PIXEL *ForeGround OPTIONAL, IN EFI_GRAPHICS_OUTPUT_BLT_PIXEL *BackGround OPTIONAL, IN CONST CHAR16 *Format, ...);
...
UINTN
EFIAPI
AsciiPrintXY(IN UINTN PointX, IN UINTN PointY, IN EFI_GRAPHICS_OUTPUT_BLT_PIXEL *ForeGround OPTIONAL, IN EFI_GRAPHICS_OUTPUT_BLT_PIXEL *BackGround OPTIONAL, IN CONST CHAR8 *Format, ...);
...
EFI_STATUS
EFIAPI
EfiLibInstallDriverBinding(IN CONST EFI_HANDLE ImageHandle, IN CONST EFI_SYSTEM_TABLE *SystemTable, IN EFI_DRIVER_BINDING_PROTOCOL *DriverBinding, IN EFI_HANDLE DriverBindingHandle);
...
EFI_STATUS
EFIAPI
EfiLibUninstallDriverBinding(IN EFI_DRIVER_BINDING_PROTOCOL *DriverBinding);
...
EFI_STATUS
EFIAPI
EfiLibUninstallAllDriverProtocols(IN EFI_DRIVER_BINDING_PROTOCOL *DriverBinding, IN CONST EFI_COMPONENT_NAME_PROTOCOL *ComponentName OPTIONAL, IN CONST EFI_DRIVER_CONFIGURATION_PROTOCOL *DriverConfiguration OPTIONAL, IN CONST EFI_DRIVER_DIAGNOSTICS_PROTOCOL *DriverDiagnostics OPTIONAL);
...
EFI_STATUS
EFIAPI
EfiLibUninstallDriverBindingComponentName2(IN EFI_DRIVER_BINDING_PROTOCOL *DriverBinding, IN CONST EFI_COMPONENT_NAME_PROTOCOL *ComponentName OPTIONAL, IN CONST EFI_COMPONENT_NAME2_PROTOCOL *ComponentName2 OPTIONAL);
...
EFI_STATUS
EFIAPI
EfiLocateProtocolBuffer(IN EFI_GUID *Protocol, OUT UINTN *NoProtocols, OUT VOID ***Buffer);
...
EFI_STATUS
EFIAPI
EfiOpenFileByDevicePath(IN OUT EFI_DEVICE_PATH_PROTOCOL **FilePath, OUT EFI_FILE_PROTOCOL **File, IN UINT64 OpenMode, IN UINT64 Attributes);
