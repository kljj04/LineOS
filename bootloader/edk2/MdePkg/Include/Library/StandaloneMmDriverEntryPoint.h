...
EFI_STATUS
EFIAPI
_ModuleEntryPoint(IN EFI_HANDLE ImageHandle, IN EFI_MM_SYSTEM_TABLE *MmSystemTable);
...
EFI_STATUS
EFIAPI
ProcessModuleEntryPointList(IN EFI_HANDLE ImageHandle, IN EFI_MM_SYSTEM_TABLE *MmSystemTable);
...
EFI_STATUS
EFIAPI
ProcessModuleUnloadList(IN EFI_HANDLE ImageHandle);
