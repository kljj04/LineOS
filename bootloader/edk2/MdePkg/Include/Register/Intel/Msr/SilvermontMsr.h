...
**/
#define IS_SILVERMONT_PROCESSOR(DisplayFamily, DisplayModel) (DisplayFamily == 0x06 && (DisplayModel == 0x37 || DisplayModel == 0x4A || DisplayModel == 0x4D || DisplayModel == 0x5A || DisplayModel == 0x5D))
