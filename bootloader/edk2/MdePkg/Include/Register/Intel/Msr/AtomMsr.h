...
**/
#define IS_ATOM_PROCESSOR(DisplayFamily, DisplayModel) (DisplayFamily == 0x06 && (DisplayModel == 0x1C || DisplayModel == 0x26 || DisplayModel == 0x27 || DisplayModel == 0x35 || DisplayModel == 0x36))
