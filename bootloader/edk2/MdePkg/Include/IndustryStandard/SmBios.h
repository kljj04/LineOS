...
#define PROCESSOR_SPECIFIC_VERSION_INFO(major, minor) ((UINT16) ((((major) & ((PROCESSOR_SPECIFIC_MAJOR_VERSION_MASK >> PROCESSOR_SPECIFIC_MAJOR_VERSION_SHIFT))) << PROCESSOR_SPECIFIC_MAJOR_VERSION_SHIFT) | (((minor) & PROCESSOR_SPECIFIC_MINOR_VERSION_MASK) << PROCESSOR_SPECIFIC_MINOR_VERSION_SHIFT)))
