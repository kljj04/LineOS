...
/**
  ...
  @param  ExpectedSize  The expected size, in bytes, of the data type specified
                        by TypeName.
**/
#define CXL_11_SIZE_ASSERT(TypeName, ExpectedSize) STATIC_ASSERT(sizeof(TypeName) == ExpectedSize, "Size of " #TypeName " does not meet CXL 1.1 Specification requirements.")
...
**/
#define CXL_11_OFFSET_ASSERT(TypeName, FieldName, ExpectedOffset) STATIC_ASSERT(OFFSET_OF(TypeName, FieldName) == ExpectedOffset, "Offset of " #TypeName "." #FieldName " does not meet CXL 1.1 Specification requirements.")
