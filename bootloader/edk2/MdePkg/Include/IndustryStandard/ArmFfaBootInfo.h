...
#define FFA_BOOT_INFO_TYPE(type) (((type) >> FFA_BOOT_INFO_TYPE_SHIFT) & FFA_BOOT_INFO_TYPE_MASK)
...
#define FFA_BOOT_INFO_TYPE_ID(type) (((type) >> FFA_BOOT_INFO_TYPE_ID_SHIFT) & FFA_BOOT_INFO_TYPE_ID_MASK)
...
#define FFA_BOOT_INFO_FLAG_NAME(flag) (((flag) >> FFA_BOOT_INFO_FLAG_NAME_SHIFT) & FFA_BOOT_INFO_FLAG_NAME_MASK)
...
#define FFA_BOOT_INFO_FLAG_CONTENT(flag) (((flag) >> FFA_BOOT_INFO_FLAG_CONTENT_SHIFT) & FFA_BOOT_INFO_FLAG_CONTENT_MASK)
