...
#define PXE_BUSTYPE(a, b, c, d) ((((PXE_UINT32) (d) & 0xFF) << 24) | (((PXE_UINT32) (c) & 0xFF) << 16) | (((PXE_UINT32) (b) & 0xFF) << 8) | ((PXE_UINT32) (a) & 0xFF))
...
#define PXE_SWAP_UINT32(n) ((((PXE_UINT32) (n) & 0x000000FF) << 24) | (((PXE_UINT32) (n) & 0x0000FF00) << 8) | (((PXE_UINT32) (n) & 0x00FF0000) >> 8) | (((PXE_UINT32) (n) & 0xFF000000) >> 24))

#define PXE_SWAP_UINT64(n) ((((PXE_UINT64) (n) & 0x00000000000000FFULL) << 56) | (((PXE_UINT64) (n) & 0x000000000000FF00ULL) << 40) | (((PXE_UINT64) (n) & 0x0000000000FF0000ULL) << 24) | (((PXE_UINT64) (n) & 0x00000000FF000000ULL) << 8) | (((PXE_UINT64) (n) & 0x000000FF00000000ULL) >> 8) | (((PXE_UINT64) (n) & 0x0000FF0000000000ULL) >> 24) | (((PXE_UINT64) (n) & 0x00FF000000000000ULL) >> 40) | (((PXE_UINT64) (n) & 0xFF00000000000000ULL) >> 56))
